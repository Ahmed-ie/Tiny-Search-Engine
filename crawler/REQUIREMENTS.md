...
1. print nothing to stdout, other than logging its progress; see an example format in the [knowledge unit](https://github.com/CS50DartmouthSP24/home/blob/main/knowledge/units/crawler.md).
